...
int main(int argc, char** argv)
{
	...
	// string output_candidateLariat_withEndSiteCanonicalWithin1base
	// 	= outputFolderStr + "candidateLariat_withEndSiteCanonicalWithin1base.junc";
	// ofstream candidateLariat_withEndSiteCanonicalWithin1base_ofs(
	// 	output_candidateLariat_withEndSiteCanonicalWithin1base.c_str());

	// string output_candidateLariat_withEndSiteCanonicalWithin1base_simAlignment 
	// 	= outputFolderStr + "candidateLariat_withEndSiteCanonicalWithin1base.sam";
	// ofstream candidateLariat_withEndSiteCanonicalWithin1base_simSAM_ofs(
	// 	output_candidateLariat_withEndSiteCanonicalWithin1base_simAlignment.c_str());
	...
	{	
		...
		else if(tmpSJstartPosInt > tmpSJendPosInt)
		{
			...
			// bool candidateLariatSJ_bool = false;
			// string spliceEndSiteFlankString_candi_1 
			// 	= indexInfo->returnTwoBasesString(tmpSJchrNameInt, tmpSJendPosInt);
			// string spliceEndSiteFlankString_candi_2 
			// 	= indexInfo->returnTwoBasesString(tmpSJchrNameInt, tmpSJendPosInt+1);
			...
			else
			{
				...
				// if((spliceEndSiteFlankString_candi_1 == "GT")||(spliceEndSiteFlankString_candi_1 == "CT")
				// 	//||(spliceEndSiteFlankString_candi_2 == "GT")||(spliceEndSiteFlankString_candi_2 == "CT")
				// 	)
				// {
				// 	candidateLariatSJ_bool = true;
				// 	candidateLariat_withEndSiteCanonicalWithin1base_ofs << juncStr << endl;
				// }
			}
			...
			for(int tmp = 0; tmp < tmpSJsupportNumInt; tmp++)
			{
				...
				// if(candidateLariatSJ_bool)
				// 	candidateLariat_withEndSiteCanonicalWithin1base_simSAM_ofs
				// 		<< tmpReadSam << endl;
			}
		}
		else
	...
	///////////////////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////////////////////////////////////
	// extract backSplice junctions with splice sites detected in normal splice junctions /
	///////////////////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////////////////////////////////////
